...
<head>
    ...
    <title><?php echo $row->page_name; ?> | Report</title>
...
<body>
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="form-group">
						<label>Type :</label>
						<select class="form-control" onChange="report_result();" id="report_type" name="report_type">
							<option value="1">Top 5 Products</option>
							<option value="2">Top 5 Movies</option>
						</select>
					</div>
				</div>
				<div class="col-lg-4">
					<div class="form-group">
						...
						<input type="date" class="form-control" id="date_from" name="date_from" onChange="report_result();" value="<?php echo date('Y-m-d');?>"/>
					</div>
				</div>
				<div class="col-lg-4">
					<div class="form-group">
						<label>Date To :</label>
						<input type="date" class="form-control" id="date_to" name="date_to" onChange="report_result();" value="<?php echo date('Y-m-d');?>"/>
					</div>
				</div>
			</div>
            <div class="row">
    ...
    <!--script src="<?php echo $this->config->base_url().'chemicals/';?>assets/scripts/morris-demo.js"></script-->
	<!-- Spinner JS -->
	...
	function report_result(){
		...
		$.post("<?php echo $this->config->base_url().'reports/get_result';?>",{report_type:report_type, date_from:date_from, date_to:date_to},function(result){
			console.log(result);
